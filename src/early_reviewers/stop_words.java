 ...
 * @author EGC
 */
public class stop_words extends javax.swing.JFrame {

    /**
     * Creates new form stop_words
     */
...
try{
Scanner fip1=new Scanner(new File(filepath)); //file here from which you want to remove the stop words
...
jTextArea1.setText(jTextArea1.getText()+s1);
...
System.err.println("cannot read file");
    ...
    private void initComponents() {
        ...
        jButton1.setText("Load Stopwords");
        ...
        jButton3.setText("Remove Stopwords");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Stopwords Loaded Successfully");
            br.close();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTextArea1.setText("");
        try{
            BufferedReader br=new BufferedReader(new FileReader("removedstopwords.txt"));
            String s1="",s2="";
            ...
            jTextArea1.setText(s2);
            JOptionPane.showMessageDialog(null, "Stopwords Removed Successfully");
            br.close();
        }catch (IOException ex)
        {}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stop_words.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
