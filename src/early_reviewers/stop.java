...
"This", "Those", "Through", "To", "Too", "Under", "Until", "Up", "Very", "Was", "Wasn’t", "We", "We’d", "We’ll", "We’re", "We’ve",
"Were", "Weren’t", "What", "What’s", "When", "When’s", "Where", "Where’s", "Which", "While", "Who", "Who’s", "Whom",
"Why", "Why’s","8","i","2","&","-","s","m","t", "With","16","7","i", "Won’t", "Would", "Wouldn’t", "You", "You’d", "You’ll", "You’re", "You’ve", "Your", "Yours", "Yourself", "Yourselves"};

try{
Scanner fip1=new Scanner(new File("./Dataset//amazon review dataset.CSV")); //file here from which you want to remove the stop words
